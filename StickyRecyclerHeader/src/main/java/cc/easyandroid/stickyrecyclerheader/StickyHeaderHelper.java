...
public class StickyHeaderHelper extends OnScrollListener {
    ...
    private static final String TAG = StickyRecyclerHeadersAdapter.class.getSimpleName();
    ...
    public StickyHeaderHelper(StickyRecyclerHeadersAdapter adapter,
                              StickyRecyclerHeadersAdapter.OnStickyHeaderChangeListener stickyHeaderChangeListener) {
        mAdapter = adapter;
...
//            mAdapter.onBindViewHolder(mStickyHeaderViewHolder, mHeaderPosition);
    ...
    private void translateHeader() {
        ...
        //Apply translation
        System.out.println("headerOffsetY=" + headerOffsetY);
    ...
    private int getHeaderPosition(int adapterPosHere) {
        ...
        Object object = mAdapter.getSectionHeader(adapterPosHere);//.stickyheader
        if (object == null) {
            return RecyclerView.NO_POSITION;
        }
        return mAdapter.getGlobalPositionOf(object);
    }
